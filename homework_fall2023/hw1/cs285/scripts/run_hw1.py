...
import pickle
import os
# PATH = "C:\\LSP\\homework_fall2023\\hw1"
# os.chdir(path=PATH)
print(os.getcwd())
...
def run_training_loop(params):
    ...
    for itr in range(params['n_iter']):
        ...
        if itr == 0:
            ...
            paths, envsteps_this_batch = utils.sample_trajectories(env, expert_policy, params['batch_size'], params['ep_len'])
        ...
        for _ in range(params['num_agent_train_steps_per_iter']):
          ...
          perm = np.random.permutation(params['train_batch_size'])
          
          ob_batch, ac_batch = replay_buffer.obs[perm], replay_buffer.acs[perm]
