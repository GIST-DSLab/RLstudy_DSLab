...
def run_training_loop(args):
    ...
    for itr in range(args.n_iter):
        ...
        observations = trajs_dict.get("observation")
        actions = trajs_dict.get("action")
        rewards = trajs_dict.get("reward")
        terminals = trajs_dict.get("terminal")
        train_info: dict = agent.update(observations, actions, rewards, terminals)
